...
// Pantalla LCD
LiquidCrystal_I2C display(0x27,SCREEN_WIDTH,SCREEN_HEIGHT);  // set the LCD address to 0x27 for a 16 chars and 2 line display
// Cliente WiFi
WiFiClient net;
// Cliente MQTT
...
const char ssid[] = "PRIVADO"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "PRIVADO"; // TODO cambiar por la contraseña de la red WiFi

//Conexión a Mosquitto
#define USER "alzate" // TODO Reemplace UsuarioMQTT por un usuario (no administrador) que haya creado en la configuración del bróker de MQTT.
const char MQTT_HOST[] = "3.80.237.19"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
const int MQTT_PORT = 8082;
const char MQTT_USER[] = USER;
//Contraseña de MQTT
const char MQTT_PASS[] = "pruebaalzate1"; // TODO Reemplace ContrasenaMQTT por la contraseña correpondiente al usuario especificado.
...
/**
 * Verifica si ha llegado algun mensaje para detonar una acción. 
